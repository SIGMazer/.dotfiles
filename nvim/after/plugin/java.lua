...
local config = {
  ...
  cmd = {
    ...
    -- 💀
    '/usr/lib/jvm/java-19-openjdk-amd64/bin/java', -- or '/path/to/java17_or_newer/bin/java'
    ...
    -- 💀
    '-jar', '/usr/lib/jvm/jdt-language-server-1.9.0-202203031534/plugins/org.eclipse.equinox.launcher_1.6.400.v20210924-0641.jar',
         -- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^                                       ^^^^^^^^^^^^^^
